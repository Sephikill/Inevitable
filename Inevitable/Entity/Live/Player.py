...
from config import *
from Entity.HP_bar import HP_BAR
...
class Player(pygame.sprite.Sprite):
	def __init__(self, game, x, y):
		...
		#Ratio thing
		self.HP_Ratio = self.MAX_HP / self.healthRectW
		...
		#HP bar class to spawn hp bar
		self.HP_BAR = HP_BAR(self.x, self.y, self.healthRectW, 10, self)
	...
	def update(self):
		...
		self.HP_BAR.set_HP(self.HP / self.HP_Ratio)
